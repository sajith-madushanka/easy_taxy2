...
<body class="bg-black text-white mt-0" data-bs-spy="scroll" data-bs-target="#navScroll">
    ...
    <main id="mainContent">
            ...
            <div class="container px-vw-6 py-vh-5">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-lg-5" data-aos="fade-left" >
                        <h3 class="pt-5">Mini Bus Servce</h3>
                        <p class="text-secondary">Daily bus service with a fixed route where you can book a seat if your next destination is on our route.<br>
                            <div class="link-fancy link-fancy-light me-2" id="minibus">Tell me more</div>
                            <svg id="minibus" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div class="container-fluid px-vw-5 position-relative" data-aos="fade">
                ...
                <div class="container bg-black px-vw-5 py-vh-3 rounded-5 shadow blck_c">
                    <div class="row d-flex align-items-center">
                        <div class="col-1"></div>
                        <div class="col-4 d-flex align-items-center bg-dark shadow rounded-5 p-0"
                            data-aos="zoom-in-up">
                    ...
                    <div class="col-12 col-lg-6" style="justify-content: center">
                        <div class="rounded-5 bg-black p-5 shadow blck_c" data-aos="zoom-in-right" style=" max-width: 480px;">
                            ...
                            <p class="text-secondary lead">"Lorem ipsum dolor sit amet, consectetur tempor incididunt
                                ...
                                consequat."</p>
                            <div
                                class="d-flex justify-content-start align-items-center border-secondary pt-3">
    ...
    <hr style="color:#FC8E01;height: 3px;background-color: #FC8E01;">
    ...
    <hr style="color:#FC8E01 ; margin-left: auto;margin-right: auto;border: none;height: 5px;background-color: #FC8E01;width: 90%">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        // mini bus service
        $('#minibus').click(function(e) {
            e.preventDefault();
            console.log('clicked');
            // AJAX request to load minibus.blade.php content
            $.ajax({
                url: "{{ route('minibus') }}",
                method: 'GET',
