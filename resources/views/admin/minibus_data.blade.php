                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <h4 id="s_title" class="sub-title">Insert Destination-Price</h4>
...
<script>
    ...
    function delete_data_popup() {
        ...
        $.ajax({
            url: '{{ url("/minibus_price") }}/' + data_del,
            type: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    function edit_data(id, destination, amount) {
        data_id = id;
